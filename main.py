...
if __name__ == '__main__':
    ...
    cfg.MODEL.WEIGHTS = 'data/model/DukeMTMC_BoT-S50.pth'
    cfg.OUTPUT_DIR = 'data/dyh/checkpoints/FastReID/tmp_log'

    # cfg.MODEL.BACKBONE.WITH_IBN = False

    thres_score = 0.6
    root_img = 'data/MOTChallenge/MOT20/train'
    dir_in_det = 'data/detections/MOT20_YOlOv11/train'
    ...
    dir_out_det = 'data/output/ResNet50'
    ...
    print("berusaha cek isi dari direktori: ", files)
